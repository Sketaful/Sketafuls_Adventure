...
V3.1.2
    ...
    * Expand_World_Data Updated to v1.61.0
    * KillMeForMyPower Updated to v2.2.3
    * UsefulPaths Updated to v1.0.9
    * WackyEpicMMOSystem Updated to v1.9.58
    * WackysDatabase updated to v2.4.72
...
## BACKUP YOUR CHARACTER AND OLD WORLD BEFORE RUNNING THIS UPDATE!!!

    UPDATED:
    * Almanac updated to v3.7.6
    * AzuCraftyBoxes updated to v1.8.13
    * AzuExtendedPlayerInventory updated to v2.3.7
    * Backpacks updated to v1.3.8
    * Drop_That updated to v3.1.4
    * Expand_World_Data updated to v1.58.0
    * Expand_World_Size updated to v1.30.0
    * Guilds updated to v1.1.13
    * MorePins updated to v420.0.11
    * TargetPortal updated to v1.2.3
    * WackysDatabase updated to v2.4.70
    * Zen_ModLib updated to v1.6.3

---

V3.1.0

### IMPORTANT! UNSTABLE RELEASE! BACKUP YOUR OLD WORLD!
    There is a lot of changes in the update to Valheim and this modpack  
    only works because of "StartupHotfix" that solves most of the problems.  
    These problems are kinda "wonky" though, so things might break that I  
    missed when testing the pack.
  
    I also had to remove the extra Seeds and Plant bags. Seems like the extra  
    bags was totally broken. Backpack should still work though.
    So make sure you go in and empty any extra bags into a chest or something  
    before running this update! You have been warned!

SO BACKUP YOUR CHARACTER AND OLD WORLD BEFORE RUNNING THIS UPDATE!!!



    REMOVED:
    * Extra two bags (seeds and plants) - Make sure you've emptied these first or lose all in them.

    UPDATED:
    * AAA_Crafting updated to v2.1.6
    * Almanac updated to v3.7.5
    * AzuExtendedPlayerInventory updated to v2.3.3
    * Backpacks updated to v1.3.7
    * Build_Camera_Custom_Hammers_Edition updated to v1.2.10
    * CookingAdditions updated to v1.3.1
    * CrystalLights updated to v1.1.8
    * Custom_Raids updated to v1.8.1
    * Drop_That updated to v3.1.3
    * DualWield updated to v1.0.10
    * Expand_World_Data updated to v1.57.0
    * Expand_World_Size updated to v1.29.0
    * Groups updated to v1.2.10
    * Guilds updated to v1.1.12
    * Intermission updated to v1.9.0
    * KillMeForMyPower updated to v2.2.2
    * MadHatter updated to v2.2.3
    * MagicPlugin updated to v2.1.9
    * OdinsSteelworks updated to v0.3.4
    * StaminaRegenerationFromFood updated to v1.5.7
    * VikingsDoSwim updated to v1.4.1
    * WackyEpicMMOSystem updated to v1.9.57
    * WackysDatabase updated to v2.4.66
    * Zen_ModLib updated to v1.6.2
    * ZenSign updated to v1.5.1

    ADDED:
    * StartupHotfix v0.1.0 by MSchmoecker
    * MyPitsDontLeak v1.0.0 by Azumatt
    * WardIsLove v3.7.2 by Azumatt
    * TeleportEverything v2.9.1 by OdinPlus (You can now transport your tames with you, but enemies might follow)

## Future plans
<small>There is some problems with the portals not working correctly in multiplayer.  
Not sure if it happens on a dedicated server (don't put Gizmo on a dedicated server btw)  
but when running the game and opening it up as a server for friends it seem to be bugging  
out and not show up for others as it should.  

The problem seem to lie with the TargetPortal mod itself and I'm thinking of removing it  
in the future. So, see this as a warning that you should read the changelog before updating  
so you don't lose a full network of portals. (easy to fix by installing TargetPortal yourself though)

The plan is to go back to default way of connecting portals but adding a couple of different ones  
allowing you to portal with some ores and stuff based on your progress. It's in the works and will  
make sense as soon as I got it all figured out. ;)</small>
...
Or if you really need them, just add them yourself. The configs for them are left in the modpack just in case.</small>

    REMOVED MODS:
    * NoBuildDust by Azumatt (Removal doesn't affect old worlds/characters)
    * NoCreatureDust Azumatt (Removal doesn't affect old worlds/characters)
    * NoCultivatorDust Azumatt (Removal doesn't affect old worlds/characters)
    * NoHoeDust Azumatt (Removal doesn't affect old worlds/characters)
    * NoWeaponDust Azumatt (Removal doesn't affect old worlds/characters)
    * NoTreeDust Azumatt (Removal doesn't affect old worlds/characters)
    * ItemHopper MSchmoecker (Removal means hoppers built in worlds will disapear, but world will work)
    * Cooking Smoothbrain (Removal removes skill from character, no more unstackable foods)
    * Blacksmithing Smoothbrain (Removal removes skill from character)
    * Farming Smoothbrain (Removal removes skill from character, same kind of skill added to vanilla Valheim)
    * Soulcatcher_JC_KG_Additions by KGvalheim (Depricated)
    * Professions Smoothbrain (Removal removes skill from character)
    * WardIsLove Azumatt (Bugged out. Removal will remove Wards from this mod)


<small>Since this modpack haven't been updated for quite some time there was a lot of mods in need of an update.</small>

    UPDATED MODS:
    * Item_Stand_All_Items updated to v1.25.0
    * Zen_ModLib updated to v1.3.5
    * WackyEpicMMOSystem updated to v1.9.50
    * WackysDatabase updated to v2.4.61
    * ZenSign updated to v1.3.8
    * ConfigurationManager updated to v1.1.10
    * Jotunn updated to v2.27.0
    * ZenRedecorate updated to v1.2.2
    * ClayBuildPieces updated to v1.2.6
    * MagicPlugin updated to v2.1.8
    * PlantEverything updated to v1.20.0
    * AzuCraftyBoxes updated to v1.8.5
    * Wagon updated to v1.1.7
    * Almanac updated to v3.5.30
    * Expand_World_Data updated to v1.54.0
    * CookingAdditions updated to v1.2.9
    * WieldEquipmentWhileSwimming updated to v1.1.3
    * VikingsDoSwim updated to v1.4.0
    * TarCollector updated to v1.1.8
    * GuckCollector updated to v1.1.7
    * GlassPieces updated to v1.2.5
    * FineWoodBuildPieces updated to v1.1.8
    * FeatherCollector updated to v1.1.9
    * CrystalCollector updated to v1.1.7
    * CoreWoodPieces updated to v1.2.4
    * Waypoints updated to v1.1.5
    * Expand_World_Size updated to v1.28.0
    * BepInExPack_Valheim updated to v5.4.2333
    * Recycle_N_Reclaim updated to v1.3.8
    * Chatter updated to v2.12.0
    * AAA_Crafting updated to v2.1.2
    * AzuExtendedPlayerInventory updated to v1.4.12
    * Custom_Raids updated to v1.8.0
    * UsefulPaths updated to v1.0.5
    * KillMeForMyPower updated to v1.3.6
    * SearsCatalog updated to v1.8.0
    * FastLink updated to v1.4.8

<small>And Finally... I did add some mods I find helpful or nice in some way. Not any big, heavy mods thought.</small>

    ADDED MODS:
    * ZenItemStands by ZenDragon (It works nicely but I love how it make you not accidently drop things from stands)  
    * ReadMe By CookieMilk 
      (Write your own story, or novel, or just a diary? In the pack more for future use by me, but anyone can make a book. :)

<small>I'm going through the mods looking for errors and bugs but since I have very limited time nowadays I do like every help reporting bugs that I could get.  
...
V2.1.24
    ...
    UPDATED:
    * AAA_Crafting updated to v2.1.1
    * Almanac updated to v3.5.19
    * AzuCraftyBoxes updated to v1.8.5
    * AzuExtendedPlayerInventory updated to v1.4.11
    * BepInExPack_Valheim updated to v5.4.2333
    * Chatter updated to v2.12.0
    * ClayBuildPieces updated to v1.2.6
    * ConfigurationManager updated to v1.1.8
    * CookingAdditions updated to v1.2.9
    * CoreWoodPieces updated to v1.2.4
    * CrystalCollector updated to v1.1.7
    * Custom_Raids updated to v1.8.0
    * Expand_World_Data updated to v1.54.0
    * Expand_World_Size updated to v1.27.0
    * FastLink updated to v1.4.8
    * FeatherCollector updated to v1.1.9
    * FineWoodBuildPieces updated to v1.1.8
    * GlassPieces updated to v1.2.5
    * GuckCollector updated to v1.1.7
    * Item_Stand_All_Items updated to v1.24.0
    * Jotunn updated to v2.26.1
    * KillMeForMyPower updated to v1.3.3
    * MagicPlugin updated to v2.1.8
    * PlantEverything updated to v1.20.0
    * Recycle_N_Reclaim updated to v1.3.8
    * SearsCatalog updated to v1.7.0
    * TarCollector updated to v1.1.8
    * VikingsDoSwim updated to v1.4.0
    * WackyEpicMMOSystem updated to v1.9.48
    * WackysDatabase updated to v2.4.58
    * WieldEquipmentWhileSwimming updated to v1.1.3
    * Zen_ModLib updated to v1.3.1
    * ZenRedecorate updated to v1.2.2
    * ZenSign updated to v1.3.6
...
V2.1.22
    ...
    UPDATED:
    * MagicPlugin will be updated to v2.1.3
    * WackyEpicMMOSystem will be updated to v1.9.39
    * WackysDatabase will be updated to v2.4.54

    EXTRA INFO:
     Quickly wrote down some info on wiki 
     about making this modpack work on a server.
...
V2.1.21
    ...
    UPDATED:
    * Zen_ModLib updated to v1.1.0
    * ZenSign updated to v1.2.4
    * ZenRedecorate updated to v1.1.3
    * Jewelcrafting updated to v1.5.36
    * BetterZeeLog updated to v1.14.0
    * AzuCraftyBoxes updated to v1.8.4
    * AllTameableTamingOverhaul updated to v1.5.3
    * PlantEverything updated to v1.19.1
...
V2.1.20
    ...
    UPDATED:
    * TargetPortal updated to v1.2.0  
    * Zen_ModLib updated to v1.0.5  
    * ZenSign updated to v1.2.3  
...
V2.1.19
    ...
    ADDED:
    * SmokeCollision v1.9.0 by JereKuusela  
      (config will be improved later)

    UPDATE:
    * CrystalLights updated to v1.1.5
    * Wagon updated to v1.1.6
    * Zen_ModLib updated to v1.0.2
    * ZenRedecorate updated to v1.1.2
    * ZenSign updated to v1.2.2

    CHANGES:
    * Clay collector time to collect raised from 120 sec to 240 sec.
	* Clay collector max capacity raised from 10 to 40.
	  (these might change :P)
    * Added some lines to the tips on loading screen and removed some of the default images.
      (as I've said before, if you have a nice screenshot from this modpack, send it and I'll add it)
...
V2.1.18
    ...
    UPDATED:
    * Almanac updated to v3.4.9  
    * Jewelcrafting updated to v1.5.35  
    * ZenRedecorate updated to v1.1.1  
    * ZenSign updated to v1.2.1  

    ADDED:
    * Zen_ModLib 1.0.0 (auto-added by any zen-mod since it's needed)

    CONFIGS:
    * Jewelcrafting config changed to not have Wisplight & Wishbone slotable  
      (use them live vanilla instead)
...
V2.1.17
    ...
    ADDED:
    * Farming by Smoothbrain (well re-added)  
      - Seems to work as it should now. Choose as profession and
        see time for crops at level 25, plant in any biome at level 50,  
        at level 100 gain double from crops.
    
    UPDATED:
    * Expand_World_Data updated to v1.53.0
    * Jewelcrafting updated to v1.5.34
...
V2.1.16
    ...
    UPDATED:
    * Drop_That updated to v3.1.1

    FIX:
    * Something seemed to be wrong with the modpack's zipfile. Fixed it (i hope).
...
V2.1.14/V2.1.15
    ...
    UPPDATED:
    * Almanac updated to v3.4.8
    * WackysDatabase will be updated to v2.4.52

    CONFIG:
    * A bunch of changes. To many to remember right now. Creatures should be a "bit" easier now thought.

    EXTRA:
    A new loading image added. Thanks @zander. :)

    V2.1.15
    Every change to anything need me to change the version, Version 2.1.14 and 2.1.15 is the same, 
    only difference was I missed adding the changelog (which you're reading right now)
...
V2.1.13
    ...
    * BetterZeeLog v1.13.0 by ComfyMods - Remove vanilla spam in console
    ...
    UPPDATED:
    * Almanac updated to v3.4.6
    * WackysDatabase updated to v2.4.52
